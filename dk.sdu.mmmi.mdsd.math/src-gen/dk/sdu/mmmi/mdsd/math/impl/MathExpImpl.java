...
public class MathExpImpl extends MinimalEObjectImpl.Container implements MathExp
{
   ...
   * @ordered
   */
  protected EList<ExternalDeclaration> externals;
   ...
   */
  @Override
  public EList<ExternalDeclaration> getExternals()
  {
    if (externals == null)
    {
      externals = new EObjectContainmentEList<ExternalDeclaration>(ExternalDeclaration.class, this, MathPackage.MATH_EXP__EXTERNALS);
    }
    return externals;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MathPackage.MATH_EXP__EXTERNALS:
        getExternals().clear();
        getExternals().addAll((Collection<? extends ExternalDeclaration>)newValue);
        return;
      case MathPackage.MATH_EXP__VARIABLES:
        getVariables().clear();
